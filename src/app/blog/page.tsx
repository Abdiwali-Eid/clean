...
export default function BlogPage() {
  return (
    <div className="flex min-h-screen flex-col bg-background-light dark:bg-background-dark text-text-main-light dark:text-text-main-dark transition-colors duration-200">
      ...
      <footer className="bg-white dark:bg-card-dark border-t border-[#e7f3eb] dark:border-[#1e3a29] pt-12 pb-8 px-4 md:px-8">
        <div className="mx-auto max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-sm text-text-sub-light dark:text-text-sub-dark mb-4">
                Advancing clean cooking solutions for a healthier, sustainable Somalia.
              </p>
            ...
            <div>
              <h3 className="font-bold text-text-main-light dark:text-text-main-dark mb-4">
                Quick Links
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-text-sub-light dark:text-text-sub-dark">
                <li className="flex items-start gap-2">
                  <span className="material-symbols-outlined text-lg mt-0.5 text-primary">
                    location_on
                  </span>
                  <span>
                    Mogadishu, Somalia
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>+252 61 555 5555</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-text-sub-light dark:text-text-sub-dark">
            <p>© 2023 Clean Cooking Association of Somalia. All rights reserved.</p>
            <div className="flex gap-6">
              <a
                className="hover:text-text-main-light dark:hover:text-text-main-dark transition-colors"
                href="#"
              >
                Privacy Policy
              </a>
